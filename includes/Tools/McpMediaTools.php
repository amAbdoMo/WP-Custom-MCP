...
class McpMediaTools {
	...
	public function wp_get_media_file( $params ): array {
		...
		$size = isset( $params['size'] ) ? sanitize_key( $params['size'] ) : 'full';
	 ...
	 * @return bool
	 */
	public function get_media_file_permission_callback( array $params = array() ): bool {
		$attachment_id = isset( $params['id'] ) ? absint( $params['id'] ) : 0;

 ...
 * Factory for creating the default WordPress MCP server.
 *
	 * This server automatically discovers and exposes registered abilities:
...
class DefaultServerFactory {
	...
	public static function create(): void {
		...
		// Auto-discover tools, resources, and prompts from abilities.
		$auto_discovered_tools     = self::discover_abilities_by_type( 'tool' );

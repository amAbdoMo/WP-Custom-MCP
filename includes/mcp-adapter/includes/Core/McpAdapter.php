...
final class McpAdapter {
	...
	public static function instance(): self {
		if ( ! isset( self::$instance ) ) {
			...
			// Register ability hooks before wp_abilities_api_init fires on init.
	...
	/**
	 * Register hooks for the default adapter abilities.
	 *
	 * These hooks must be registered before WordPress fires wp_abilities_api_init.
	 *
	 * @internal For use by instance initialization only.
	 */

...
trait McpAbilityHelperTrait {
	...
	/**
	 * Checks if ability can be accessed via MCP.
	 *
	 * This patched adapter exposes every registered ability through the MCP
	 * wrapper tools. Individual ability permission callbacks are still enforced
	 * before execution.
	 *
	...
	/**
	 * Checks if ability is accessible via MCP (simple boolean version).
	 *
